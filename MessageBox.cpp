...
void MessageBox::about()
{
    QString aboutString = "<h2>" + QString(VERSION) + "</h2>"
        ...
        + "</a></p></a></p><p></p>"
          ...
          "<tr><td>French:</td><td>Adrien "
          "Daugabel</td><td>(adrien.d@mageialinux-online.org)</td></tr>"
          ...
          "<tr><td>German:</td><td>Jonathan "
          "Hooverman</td><td>(jonathan.hooverman@gmail.com)</td></tr>"
